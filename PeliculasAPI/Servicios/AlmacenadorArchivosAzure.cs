...
namespace PeliculasAPI.Servicios
{
    public class AlmacenadorArchivosAzure : IAlmacenadorArchivos
    {
        ...
        {
            connectionString = configuration.GetConnectionString("AzureStorage"); // para conectarse al 
            //azure indicado en appsettings.Developments
        }
        ...
        public async Task BorrarArchivo(string ruta, string contenedor)
        {
            ...
            {
                return; //No hay imagen, no se hace nada 
            }
